    ...
    <section className="py-16 px-4 bg-gray-50">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative">
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2 w-0.5 h-full border-l-2 border-dashed border-black">
            {/* Top Circle */}
              ...
              <div key={step.id} className="relative flex">
                ...
                >
                  <div className={`w-full max-w-sm ${step.side === "left" ? "md:mr-8" : "md:ml-8"}`}>
                    <div className="bg-gradient-to-t from-blue-200 to-green-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow duration-300">
